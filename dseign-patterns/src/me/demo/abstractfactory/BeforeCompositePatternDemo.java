package me.demo.abstractfactory;
...
class File {
	...
	public void ls() {
		System.out.println(BeforeCompositePatternDemo.compositeBuilder + name);
	}
}
...
class Directory {
	...
	public void ls() {
		System.out.println(BeforeCompositePatternDemo.compositeBuilder + name);
		BeforeCompositePatternDemo.compositeBuilder.append("   ");
		...
		BeforeCompositePatternDemo.compositeBuilder.setLength(BeforeCompositePatternDemo.compositeBuilder.length() - 3);
	}
}

public class BeforeCompositePatternDemo {
